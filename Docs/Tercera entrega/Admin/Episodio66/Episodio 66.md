...
## Modificamos los siguientes archivos, substituyendo su contenido por uno más limpio y ordenado:
...
```
## Y se crea un nuevo componente para la barra lateral(resources/views/components/setting.blade.php):
```php
@props(['heading'])
...
- [Episodio 67](../Episodio67/Episodio%2067.md)